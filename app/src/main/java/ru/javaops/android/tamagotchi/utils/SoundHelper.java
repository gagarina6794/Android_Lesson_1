...
public class SoundHelper {
    ...
    public static void initialSoundPool(Context context) {
        if (soundPool == null) {
            ...
            soundMap.put(PetsType.CAT, soundPool.load(context, R.raw.cat, 1));
            soundMap.put(PetsType.DOG, soundPool.load(context, R.raw.dog, 1));
            soundMap.put(PetsType.CTHULHU, soundPool.load(context, R.raw.cthulhu, 1));
        }
    }
